...
public class PopulateCustomersHashmap{
	...
	void populateCustomers(){
			...
			Customer c1 = new Customer("Rumin", "Shah", "rshah90@hawk.iit.edu", "password", "7735163183");
			System.out.println("\t Customer Id : "+c1.getcustomerId());
			customers.put(c1.getemailId(), c1);
			
			Customer c2 = new Customer("Mayur", "Shah", "mshah90@hawk.iit.edu", "password", "7735163183");
