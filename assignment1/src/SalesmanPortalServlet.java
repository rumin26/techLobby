...
public class SalesmanPortalServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<header><h1><a href=\"/\">tech<span>Lobby</span></a></h1><h2>Best Price Guaranteed</h2><h3>Salesman Portal</h3></header>");
		out.println("<nav><ul>");
		...
		{	
			...
			out.println("<form action=\"/assignment1/CreateCustomer\" method=\"get\">");
