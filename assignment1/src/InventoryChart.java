...
public class InventoryChart extends HttpServlet {
	...
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException, IOException {
		...
		out.println("data.addColumn('string', 'Product Name'); data.addColumn('number', 'Available Quantity');");
		...
		for(Map.Entry<String, ArrayList<Object>> m :phones.entrySet())
			{
				...
				out.println(" data.addRows([['"+name+"', "+quantity+"]]);");
			}
				
        // Set chart options
        out.println("var options = {'title':'Available Phones','width':600,'height':600};");
        ...
        // Set chart options
        out.println("var options = {'title':'Available Laptops','width':600,'height':600};");
        ...
        // Set chart options
        out.println("var options = {'title':'Available Smart Watches','width':600,'height':600};");
        ...
        // Set chart options
        out.println("var options = {'title':'Available Speakers','width':1000,'height':600};");
        ...
        // Set chart options
        out.println("var options = {'title':'Available Headphones','width':900,'height':600};");
        ...
        // Set chart options
        out.println("var options = {'title':'Available External Storages','width':900,'height':600};");
        ...
        // Set chart options
        out.println("var options = {'title':'Available Accessories','width':900,'height':600};");
