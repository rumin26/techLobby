...
public class DealMatches implements java.io.Serializable {
	...
	public HashMap<String, Product> getSelectedProductsFromTweets()
	{
		...
		productMap = (HashMap<String, Product>)products.get(7);
		...
		try
		{
			for(Map.Entry<String, Product> entry: productMap.entrySet())
			{
				...
				{
					BufferedReader reader = new BufferedReader(new FileReader(new File("C:\\apache-tomcat-7.0.34\\webapps\\assignment1\\DealMatches.txt")));
